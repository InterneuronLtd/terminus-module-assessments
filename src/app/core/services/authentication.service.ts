...
import { throwError, from, firstValueFrom } from 'rxjs';
...
export class AuthenticationService {
  ...
  public async requestToken() {
    ...
    await firstValueFrom(this.httpClient.post(`${AssessmentsModuleConfigData.Config.identity_service.base_uri}/connect/token`, "grant_type=client_credentials&client_id=client&client_secret=secret&scope=dynamicapi.read",
      { headers: headers }))
      .then((resp: any) => {
